...
class FulfillmentPreviewShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'earliest_ship_date' => '\Thecodebunny\AmzSpApi\Models\Timestamp',
'latest_ship_date' => '\Thecodebunny\AmzSpApi\Models\Timestamp',
'earliest_arrival_date' => '\Thecodebunny\AmzSpApi\Models\Timestamp',
'latest_arrival_date' => '\Thecodebunny\AmzSpApi\Models\Timestamp',
'fulfillment_preview_items' => '\Thecodebunny\AmzSpApi\Models\FulfillmentPreviewItemList'    ];
...
'fulfillment_preview_items' => 'getFulfillmentPreviewItems'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['earliest_ship_date'] === null) {
            $invalidProperties[] = "'earliest_ship_date' can't be null";
        }
        if ($this->container['latest_ship_date'] === null) {
            $invalidProperties[] = "'latest_ship_date' can't be null";
        }
        if ($this->container['earliest_arrival_date'] === null) {
            $invalidProperties[] = "'earliest_arrival_date' can't be null";
        }
        if ($this->container['latest_arrival_date'] === null) {
            $invalidProperties[] = "'latest_arrival_date' can't be null";
        }
     ...
     *
     * @param \Thecodebunny\AmzSpApi\Models\Timestamp $earliest_ship_date earliest_ship_date
     *
     * @return $this
     */
     ...
     *
     * @param \Thecodebunny\AmzSpApi\Models\Timestamp $latest_ship_date latest_ship_date
     *
     * @return $this
     */
     ...
     *
     * @param \Thecodebunny\AmzSpApi\Models\Timestamp $earliest_arrival_date earliest_arrival_date
     *
     * @return $this
     */
     ...
     *
     * @param \Thecodebunny\AmzSpApi\Models\Timestamp $latest_arrival_date latest_arrival_date
     *
     * @return $this
     */
     ...
     *
     * @return \Thecodebunny\AmzSpApi\Models\FulfillmentPreviewItemList
     */
     ...
     *
     * @param \Thecodebunny\AmzSpApi\Models\FulfillmentPreviewItemList $fulfillment_preview_items fulfillment_preview_items
     *
     * @return $this
     */
