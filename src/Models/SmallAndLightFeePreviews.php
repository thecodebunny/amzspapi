...
class SmallAndLightFeePreviews implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'data' => '\Thecodebunny\AmzSpApi\Models\FeePreview[]'    ];
     ...
     * Gets data
     *
     * @return \Thecodebunny\AmzSpApi\Models\FeePreview[]
     */
     ...
     * Sets data
     *
     * @param \Thecodebunny\AmzSpApi\Models\FeePreview[] $data A list of fee estimates for the requested items. The order of the fee estimates will follow the same order as the items in the request, with duplicates removed.
     *
     * @return $this
     */
