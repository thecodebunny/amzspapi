...
class AuthorizationApi
{
     ...
     * @return \Thecodebunny\AmzSpApi\Models\GetAuthorizationCodeResponse
     */
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetAuthorizationCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthorizationCodeWithHttpInfo($selling_partner_id, $developer_id, $mws_auth_token)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetAuthorizationCodeResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetAuthorizationCodeResponse',
