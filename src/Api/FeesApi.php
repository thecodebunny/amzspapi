...
class FeesApi
{
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateRequest $body body (required)
     * @param  string $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateRequest $body (required)
     * @param  string $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyFeesEstimateForASINWithHttpInfo($body, $asin)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetMyFeesEstimateResponse',
