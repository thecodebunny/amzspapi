...
class ProductPricingApi
{
     ...
     * @return \Thecodebunny\AmzSpApi\Models\GetPricingResponse
     */
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetPricingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompetitivePricingWithHttpInfo($marketplace_id, $item_type, $asins = null, $skus = null)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetPricingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetPricingResponse',
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\GetOffersResponse
     */
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetOffersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemOffersWithHttpInfo($marketplace_id, $item_condition, $asin)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetOffersResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetOffersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
