...
class SmallAndLightApi
{
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\ErrorList',
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\SmallAndLightEligibility
     */
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\SmallAndLightEligibility, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSmallAndLightEligibilityBySellerSKUWithHttpInfo($seller_sku, $marketplace_ids)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\SmallAndLightEligibility';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\SmallAndLightEligibility',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\SmallAndLightEnrollment
     */
     ...
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\SmallAndLightEnrollment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSmallAndLightEnrollmentBySellerSKUWithHttpInfo($seller_sku, $marketplace_ids)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\SmallAndLightEnrollment';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\SmallAndLightEnrollment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviewRequest $body body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviews
     */
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviewRequest $body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviews, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSmallAndLightFeePreviewWithHttpInfo($body)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviews';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\SmallAndLightFeePreviews',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
