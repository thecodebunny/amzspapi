...
class MerchantFulfillmentApi
{
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsRequest $body body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsResponse
     */
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsRequest $body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdditionalSellerInputsWithHttpInfo($body)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetAdditionalSellerInputsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesRequest $body body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesResponse
     */
     ...
     *
     * @param  \Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesRequest $body (required)
     *
     * @throws \Thecodebunny\AmzSpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEligibleShipmentServicesWithHttpInfo($body)
    {
        $returnType = '\Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\AmzSpApi\Models\GetEligibleShipmentServicesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
